...
struct ContentView: View {
    ...
    @State private var exerciseStates: [ExerciseState] = [
        ExerciseState(exerciseName: "Bench Press", 
                      lastWeightValue: 135.0,
                      lastRepValue: 8,
                      lastRPEValue: 7,
                      setCount: 3,
                      showCheckmark: false),
        
        ExerciseState(exerciseName: "Squat",
                      lastWeightValue: 185.0,
                      lastRepValue: 6, lastRPEValue: 8,
                      setCount: 4,
                      showCheckmark: false),
        
        ExerciseState(exerciseName: "Deadlift",
                      lastWeightValue: 225.0,
                      lastRepValue: 5,
                      lastRPEValue: 9,
                      setCount: 3,
                      showCheckmark: false),
